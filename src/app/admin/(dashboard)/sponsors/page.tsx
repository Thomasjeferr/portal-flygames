      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded bg-netflix-gray text-white font-medium hover:bg-white/20"
          >
            ...
            <tbody className="divide-y divide-white/5">
              {sponsors.map((s) => (
                <tr key={s.id} className="hover:bg-white/5">
                  ...
                  <td className="px-4 py-3 text-netflix-light text-sm">{s.planId ? 'Vinculado' : '—'}</td>
